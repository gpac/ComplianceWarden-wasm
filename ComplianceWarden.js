...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5263472,
    DYNAMIC_BASE = 5263472,
    DYNAMICTOP_PTR = 20560;
...
var wasmBinaryFile = 'ComplianceWarden.wasm';
...
var real__specCheckC = asm["_specCheckC"];
asm["_specCheckC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__specCheckC.apply(null, arguments);
};

var real__specFindC = asm["_specFindC"];
asm["_specFindC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__specFindC.apply(null, arguments);
};

var real__specListRulesC = asm["_specListRulesC"];
asm["_specListRulesC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__specListRulesC.apply(null, arguments);
};
...
var _specCheckC = Module["_specCheckC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_specCheckC"].apply(null, arguments)
};

var _specFindC = Module["_specFindC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_specFindC"].apply(null, arguments)
};

var _specListRulesC = Module["_specListRulesC"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_specListRulesC"].apply(null, arguments)
};
